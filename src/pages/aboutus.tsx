      ...
      <Stack direction={{ base: "column", md: "row" }} justifyContent="center">
        ...
        >
          ...
          >
            ...
            redefine the educational journey of every students, making the
            admission process as easy as possible along with the most informed
            and efficient methods. At the core of Shiksha Finder's mission is
            the belief that every student deserves the best education possible.
            We recognize that choosing the right school or learning platform
            isthe most important decision that shapes a student's academic and
            personal growth. Our mission is to empower students and parents with
            the tools and insights needed to make this decision wisely.
          </Text>
          <HStack
            spacing={{ base: 0, sm: 2 }}
